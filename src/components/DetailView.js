                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.actionButtonContainerRoot}>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#f08e25'} style={{backgroundColor: '#941a1d'}} icon="phone" mode="contained" onPress={() => console.log('Pressed')}>
                                Call
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#f08e25'} style={{backgroundColor: '#941a1d'}} icon="email" mode="contained" onPress={() => console.log('Pressed')}>
                                E-mail
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#f08e25'} style={{backgroundColor: '#941a1d'}} icon="message-alert" mode="contained" onPress={() => console.log('Pressed')}>
                                SMS
                            </Button>
                        </View>
                    </View>
